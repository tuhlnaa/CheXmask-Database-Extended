...
if __name__ == "__main__":
    ...
    # dataset_identifier = ""
    # dataset_path = download_kaggle_data(dataset_identifier)
    # print(f"Dataset downloaded and saved to: {dataset_path}")
    
    # Example usage for competition dataset
    # You usually need to accept the competition rules to access the data
    competition_identifier = "vinbigdata-chest-xray-abnormalities-detection"  # Competition name
    competition_path = download_kaggle_data(competition_identifier, 
                                            destination_dir=r"./download", 
                                            is_competition=True)
    print(f"Competition dataset downloaded and saved to: {competition_path}")
