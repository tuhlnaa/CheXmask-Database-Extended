...
plt.imshow(mask)
plt.scatter(rightLungLandmarks[:, 0], rightLungLandmarks[:, 1], color=(1.0, 0.0, 1.0))
plt.scatter(leftLungLandmarks[:, 0], leftLungLandmarks[:, 1], color=(1.0, 0.0, 1.0))
plt.scatter(heartLandmarks[:, 0], heartLandmarks[:, 1], color=(1.0, 1.0, 0.0))
